...
You can install XAMPP and run mysql and Apache services. Then 
create a new database like **restapi123**. then select the 
database and run the following sql command:
...
Then add some demo programming languages like:
...
Pay attention to the folder structure and installed 
packages in the source code.

### Swagger
This project utilizes swagger-ui for demonstration and 
testing purposes. you can access it from the following
URI:
